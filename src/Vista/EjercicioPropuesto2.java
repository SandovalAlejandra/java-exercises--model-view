...
public class EjercicioPropuesto2 extends javax.swing.JFrame {
    ...
    Vendedor[] arrayVen = new Vendedor[10];
    int pos = 0;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Monto de Ventas");
        ...
        jLabel3.setText("COMISION DE VENDEDORES");
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        arrayVen[pos] = new Vendedor(monto, nombre);
        
        txtArea.setText("");
         for(int i=0;i<=pos;i++){
           txtArea.append(arrayVen[i].getInformacion()); 
        }        
